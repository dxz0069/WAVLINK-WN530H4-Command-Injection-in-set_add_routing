# VulnDB Submission: 360 360 M5 n360.cgi FUN_0001421c OS Command Injection

## 1. Title

360 360 M5 n360.cgi FUN_0001421c OS Command Injection

## 2. Vulnerability Summary

- **Internal Tracking ID:** FRV-360-CMD-001
...
- **Affected Component:** web/cgi-bin/n360.cgi ? FUN_0001421c @ 0x1421c
- **Architecture:** MIPS32 (Big Endian)

## 4. Description

OS command injection in FUN_0001421c (0x1421c) of n360.cgi in 360 360 M5 firmware M5-4.0.17.1566-rel-upgrade.bin. User parameters (type) read via get_form_value() flow to system() without sanitization. Pattern: Speed test — get_form_value→snprintf→system('/bin/spd_down_test')+execlp
...
- **Sink**: system()
- **Binary strings**: /bin/spd_down_test, /tmp/speed_test_flag.file, echo '"status":0,"band":0' > /tmp/test_speed
