# VulnDB Submission: 360 360 POP F5 n360.cgi FUN_00019da8 OS Command Injection

## 1. Title

360 360 POP F5 n360.cgi FUN_00019da8 OS Command Injection

## 2. Vulnerability Summary

- **Internal Tracking ID:** FRV-360-CMD-002
...
- **Affected Component:** web/cgi-bin/n360.cgi ? FUN_00019da8 @ 0x19da8
- **Architecture:** MIPS32 (Big Endian)

## 4. Description

OS command injection in FUN_00019da8 (0x19da8) of n360.cgi in 360 360 POP F5 firmware 360POP-F5-V3.1.3.64296.bin. User parameters (type) read via get_form_value() flow to system() without sanitization. Pattern: Speed test — get_form_value→sprintf('/bin/spd_down_test %d')→system
...
- **Sink**: system()
- **Binary strings**: /bin/spd_down_test, /bin/spd_down_test %d
