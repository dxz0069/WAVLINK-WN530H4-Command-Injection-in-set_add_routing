# VulnDB Submission: 360 360 P4C n360.cgi FUN_00406d78 OS Command Injection

## 1. Title

360 360 P4C n360.cgi FUN_00406d78 OS Command Injection

## 2. Vulnerability Summary

- **Internal Tracking ID:** FRV-360-CMD-003
...
- **Affected Component:** web/cgi-bin/n360.cgi ? FUN_00406d78 @ 0x406d78
- **Architecture:** MIPS32 (Big Endian)

## 4. Description

OS command injection in FUN_00406d78 (0x406d78) of n360.cgi in 360 360 P4C firmware 360-P4C-V2.0.4.59512.bin. User parameters (type) read via get_form_value() flow to system() without sanitization. Pattern: Speed test — get_form_value→snprintf→system('echo ... > /tmp/test_speed')
